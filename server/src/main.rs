...
struct Car {
    ...
    total_distance: f32,   // Total distance traveled in km
    finished_time: u64,    // Ticks taken to finish
    base_performance: f32, // 0.9 to 1.1 multiplier
    speed: f32,            // Current speed in km/h
...
struct CarClientData {
    ...
    race_position: u32,
    track_position: f32, // Combined lap.percentage
    status: CarStatus,
    tire: ClientTireData,
    fuel: f32,
    driving_style: DrivingStyle,
